...
.main-images img{
    ...
    transform: scale(1.2);
    object-fit: cover;
    animation:sco 0.3s ease-in-out;
}
...
h2{
    ...
    color: #555;
    margin-bottom:  20px;
    animation:appr 0.4s ease-in-out;
...
.review{
    ...
    border-radius: 5px;
    font-size: 15px;
    animation:appr 0.45s ease-in-out;
}

.review .uil{
    counter-reset: #fff;
    animation:appr 0.47s ease-in-out;
...
strike{
    ...
    animation:appr 0.55s ease-in-out;
}

.b{
animation:op 0.7s ease-in;
}
...
select{
animation:appr 0.62s ease-in-out;
}

#plus{
animation:appr 0.63s ease-in-out;
}

#minus{
animation:appr 0.65s ease-in-out;
}
...
.buy{
    margin-top: 10%;
    margin-left: 15px;
    animation:appry 0.7s ease-in-out;
}
...
#input{
    ...
    margin-left: 5px;
    margin-right: 5px;
animation:appr 0.64s ease-in-out;
}
