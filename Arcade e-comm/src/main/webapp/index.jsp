...
<hr>
	...
	%>
           ...
           <a href="cart.jsp" style="text-decoration: none; color: black;  margin-left:41%;">   <button class="navbut bg-red text-white fs-100 fs-montserrat bold-500" style="text-decoration: none; transform:scale(0.8); " >Cart</button> </a>
          </div>
      </div>
    ...
    <main class="hero-section">
        ...
        <div class="hero-inner flex">
            <div id="bt1">
                <a href="#pd"><button class="large-btn bg-black text-white  fs-poppins fs-50 bold-500" id="fbtn"> Explore categories </button></a>
            </div>
            <div class="hero-info">
    ...
    <section id="pd" class="product-section">
        ...
        <div class="category bg-black grid">
            <div>
                ...
                <a href="#bs"><button class="product-btn large-btn text-white bg-red fs-montserrat"> Browse </button></a>
            </div>
        ...
        <div class="category bg-yellow grid">
            <div>
                ...
                <a href="#bs"><button class="product-btn large-btn text-yellow bg-white fs-montserrat"> Browse </button></a>
            </div>
        ...
        <div class="category bg-red grid">
            <div>
                ...
                <a href="#bs"><button class="product-btn large-btn text-red bg-green fs-montserrat"> Browse </button></a>
            </div>
        ...
        <div class="category bg-grey grid">
            <div>
                ...
                <a href="#bs"><button class="product-btn large-btn text-gray bg-blue fs-montserrat"> Browse </button></a>
            </div>
        ...
        <div class="category bg-green grid">
            <div>
                ...
                <a href="#bs"><button class="product-btn large-btn text-green bg-light-gray fs-montserrat"> Browse </button></a>
            </div>
        ...
        <div class="category bg-blue grid">
            <div>
                ...
                <a href="#bs"><button class="product-btn large-btn text-blue bg-yellow fs-montserrat"> Browse </button></a>
            </div>
        ...
        <div class="category bg-green grid">
            <div>
                ...
                <a href="#bs"><button class="product-btn large-btn text-green bg-grey fs-montserrat"> Browse </button></a>
            </div>
...
<section class="feature-section bg-red">
 ...
 <section class="best-product container">
    ...
    <p class="fs-montserrat fs-100">speaker There are many variations passages</p>
</section>
 ...
 <section class="feature-section bg-green">
    ...
    <div class="feature-info" >
         ...
         <button class="product-btn large-btn text-green bg-white fs-poppins">Shop</button>
    </div>
</section>
...
<section class="recent-news grid">
  ...
  <div class="fs-montserrat fs-100 flex">
    ...
    <p class="fs-montserrat padding-inline fs-100"> when we need a gadget desparately we ofter ignore few quality facts and checks before purchasing .
    </p>
  </div>
  <!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
